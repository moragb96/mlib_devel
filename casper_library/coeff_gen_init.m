  ...
  if length(ActualCoeffs) == 1,
    ...
    if (inorder == 1) || strcmp(coeff_generation, 'off'),
      ...
      reuse_block(blk, 'cosin', 'casper_library_downconverter/cosin', ...
        ...
        'bram_latency', num2str(bram_latency), 'add_latency', num2str(add_latency), ...
        'mux_latency', '2', 'neg_latency', num2str(add_latency+conv_latency), 'conv_latency', num2str(conv_latency), ...
