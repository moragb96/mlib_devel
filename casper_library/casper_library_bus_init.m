function casper_library_bus_init()
	...
	set_param([blk,'/bus_mult'], ...
		...
		'pipeline_cmult_en', sprintf('on'), ...
		'pipeline_latency', sprintf('2'), ...
...
function bus_mult_mask(blk)
	...
	set_param(blk, ...
		...
		'MaskVariables', sprintf('n_bits_a=@1;bin_pt_a=@2;type_a=@3;cmplx_a=&4;n_bits_b=@5;bin_pt_b=@6;type_b=@7;cmplx_b=&8;misc=&9;floating_point=@10;float_type=@11;input_vec_a=@12;input_vec_b=@13;frac_width=@14;exp_width=@15;n_bits_out=@16;bin_pt_out=@17;type_out=@18;quantization=@19;overflow=@20;mult_latency=@21;add_latency=@22;conv_latency=@23;max_fanout=@24;fan_latency=@25;multiplier_implementation=&26;pipeline_cmult_en=@27;pipeline_latency=@28;'), ...
		'MaskValueString', sprintf('0|4|1|on|4|3|1|on|on|off|single|1|1|19|6|12|7|1|0|0|3|1|1|2|0|behavioral HDL|on|2'), ...
		'BackgroundColor', sprintf('[0.501961, 1.000000, 0.501961]'));
...
function bus_negate_mask(blk)
	...
	set_param(blk, ...
		...
		'MaskPromptString', sprintf('input bit widths|input binary points |input complex|misc support|floating point|float type|exponent width|fraction width|n_vectors|overflow strategy (Wrap=0, Saturate=1, Flag as error=2)|latency'), ...
		'MaskStyleString', sprintf('edit,edit,checkbox,checkbox,checkbox,radiobutton(single|custom),edit,edit,edit,edit,edit'), ...
		...
		'MaskVariables', sprintf('n_bits_in=@1;bin_pt_in=@2;cmplx=&3;misc=&4;floating_point=@5;float_type=@6;exp_width=@7;frac_width=@8;n_vectors=@9;overflow=@10;latency=@11;'), ...
		'MaskValueString', sprintf('0|8|off|off|on|single|8|24|1|1|2'), ...
		'BackgroundColor', sprintf('[0.501961, 1.000000, 0.501961]'));
